...
void VulkanEngine::init_triangle_pipeline()
{
	...
	// not using descriptor sets or other systems yet, so no need to use anything other than empty defaults
	...
	// connecting the veretex and pixel shaders to the pipeline
